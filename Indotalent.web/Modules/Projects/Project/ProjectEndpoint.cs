using Indotalent.Projects.Columns;
using Indotalent.Projects.Project.Columns;
...
{
    [Route("Services/Projects/Project/[action]")]
    ...
    public class ProjectController : ServiceEndpoint
    {
            ...
            [FromServices] IExcelExporter exporter)
        {
            ...
            var bytes = exporter.Export(data, typeof(ProjectColumns), request.ExportColumns);
