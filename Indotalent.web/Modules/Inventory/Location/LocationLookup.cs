...
namespace Indotalent.Web.Modules.Inventory.Location
{

    [LookupScript]
    public sealed class LocationLookup : RowLookupScript<LocationRow>
    {
        public LocationLookup(ISqlConnections sqlConnections)
            : base(sqlConnections)
        {
