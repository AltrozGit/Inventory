...
{
    [ConnectionKey("Default"), Module("Inventory"), TableName("[dbo].[NegativeAdjustment]")]
    [DisplayName("Negative Adjustments"), InstanceName("Negative Adjustment")]
    [ReadPermission("Inventory:NegativeAdjustment")]
    [ModifyPermission("Inventory:NegativeAdjustment")]
    [LookupScript(LookupType = typeof(MultiTenantRowLookupScript<>))]
    public sealed class NegativeAdjustmentRow : LoggingRow<NegativeAdjustmentRow.RowFields>, IIdRow, INameRow, IMultiTenantRow
    {
        ...
        [DisplayName("Items"), MasterDetailRelation(foreignKey: "NegativeAdjustmentId"), NotMapped]
        public List<NegativeAdjustmentDetailRow> ItemList
        {
        ...
        public NegativeAdjustmentRow()
            : base()
        {
        }

        public NegativeAdjustmentRow(RowFields fields)
            : base(fields)
        {
        }
        ...
        public class RowFields : LoggingRowFields
        {
            ...
            public RowListField<NegativeAdjustmentDetailRow> ItemList;
