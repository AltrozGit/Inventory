...
{
    [Route("Services/Inventory/Shipper/[action]")]
    ...
    public class ShipperController : ServiceEndpoint
    {
            ...
            [FromServices] IExcelExporter exporter)
        {
            ...
            var bytes = exporter.Export(data, typeof(Columns.ShipperColumns), request.ExportColumns);
            return ExcelContentResult.Create(bytes, "ShipperList_" +
