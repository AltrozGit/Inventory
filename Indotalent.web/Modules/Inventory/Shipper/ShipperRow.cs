...
{
    [ConnectionKey("Default"), Module("Inventory"), TableName("[dbo].[Shipper]")]
    [DisplayName("Shippers"), InstanceName("Shipper")]
    [LookupScript(LookupType = typeof(MultiTenantRowLookupScript<>))]
    [ReadPermission("Inventory:Shipper")]
    [ModifyPermission("Inventory:Shipper")]
    public sealed class ShipperRow : LoggingRow<ShipperRow.RowFields>, IIdRow, INameRow, IMultiTenantRow
    {
