...
{
    [ConnectionKey("Default"), Module("Inventory"), TableName("[dbo].[Warehouse]")]
    [DisplayName("Warehouses"), InstanceName("Warehouse")]
    [LookupScript(LookupType = typeof(MultiTenantRowLookupScript<>))]
    [ReadPermission("Inventory:Warehouse")]
    [ModifyPermission("Inventory:Warehouse")]
    public sealed class WarehouseRow : LoggingRow<WarehouseRow.RowFields>, IIdRow, INameRow, IMultiTenantRow
    {
