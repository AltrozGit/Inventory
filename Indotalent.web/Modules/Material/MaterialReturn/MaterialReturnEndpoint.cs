...

{
    ...
    [Route("Services/Material/MaterialReturn/[action]")]

    [ConnectionKey(typeof(MyRow)), ServiceAuthorize(typeof(MyRow))]

    public class MaterialReturnController : ServiceEndpoint

    {
        ...
        public SaveResponse Create(IUnitOfWork uow, SaveRequest<MyRow> request,
            ...
            [FromServices] IMaterialReturnSaveHandler handler)
        ...
        public DeleteResponse Delete(IUnitOfWork uow, DeleteRequest request,
            ...
            [FromServices] IMaterialReturnDeleteHandler handler)
        ...
        public RetrieveResponse<MyRow> Retrieve(IDbConnection connection, RetrieveRequest request,
            ...
            [FromServices] IMaterialReturnRetrieveHandler handler)
        ...
        public ListResponse<MyRow> List(IDbConnection connection, ListRequest request,
            ...
            [FromServices] IMaterialReturnListHandler handler)
...

        {
            ...
            using (var package = new ExcelPackage())
            {
                ...
                var ws = package.Workbook.Worksheets.Add("MaterialReturn Excel Report");
                ws.Cells["A1"].Value = "Number";
                ws.Cells["B1"].Value = "Month - Year";
                ws.Cells["C1"].Value = "Return Date";
                ws.Cells["D1"].Value = "MaterialIssue Number";
                ...
                foreach (var d in data)
                {
                    ...
                    ws.Cells["D" + rowIndex].Value = d.MaterialIssueNumber;
                ...
                var excelTable = ws.Tables.Add(ws.Cells["A1:E" + totalRows], "MaterialReturnTable");
              ...
              "MaterialReturnExcelDownload_" + DateTime.Now.ToString("yyyyMMdd_HHmmss", CultureInfo.InvariantCulture) + ".xlsx");
            }




            //var bytes = exporter.Export(data, typeof(Columns.MaterialReturnColumns), request.ExportColumns);

            //return ExcelContentResult.Create(bytes, "MaterialReturnList_" +
