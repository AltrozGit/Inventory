//using Indotalent.Web.Modules.Leave.LeaveApprove.RequestHandlers;
...
{
    [Route("Services/Material/Request/[action]")]
    [ConnectionKey(typeof(MyRow)), ServiceAuthorize(typeof(MyRow))]
	public class MaterialRequestController : ServiceEndpoint
    {
            ...
            [FromServices] IExcelExporter exporter)
        {
            ...
            using (var package = new ExcelPackage())
            {
                ...
                var ws = package.Workbook.Worksheets.Add("MaterialRequest Excel Report");
                ...
                var excelTable = ws.Tables.Add(ws.Cells["A1:G" + totalRows], "MaterialRequestTable");
              ...
              "MaterialRequestExcelDownload_" + DateTime.Now.ToString("yyyyMMdd_HHmmss", CultureInfo.InvariantCulture) + ".xlsx");
            }
		...
		//[HttpPost]
		//public RequestActionResponse ActionStatus(IDbConnection connection, RequestActionRequest request,
		//	[FromServices] IRequestActionHandler handler)
		//{
		//	var currentAction = request.CurrentAction;

			


		//	return handler.ActionStatus(connection, request);
		//}
