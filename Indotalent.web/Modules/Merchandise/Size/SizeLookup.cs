...
namespace Indotalent.Web.Modules.Merchandise.Size
{ 

    [LookupScript]
    public sealed class SizeLookup : RowLookupScript<SizeRow>
    {
        public SizeLookup(ISqlConnections sqlConnections)
            : base(sqlConnections)
        {
