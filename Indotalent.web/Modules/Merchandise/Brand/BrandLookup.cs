...
namespace Indotalent.Web.Modules.Merchandise.Brand
{ 

    [LookupScript]
    public sealed class BrandLookup : RowLookupScript<BrandRow>
    {
        public BrandLookup(ISqlConnections sqlConnections)
            : base(sqlConnections)
        {
