...
namespace Indotalent.Web.Modules.Merchandise.Flavour
{ 

    [LookupScript]
    public sealed class FlavourLookup : RowLookupScript<FlavourRow>
    {
        public FlavourLookup(ISqlConnections sqlConnections)
            : base(sqlConnections)
        {
