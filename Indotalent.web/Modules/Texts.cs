    ...
    public static partial class Texts
    {
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                public static class SignUp
                {
                    ...
                    public static LocalText FormTitle = "Sign up for Indotalent";
        ...
        public static class Site
        {
            ...
            public static class UserDialog
            {
				...
				public static LocalText EditProjectsButton = "Edit Projects";
			...
			public static class UserProjectsDialog
			{
				public static LocalText DialogTitle = "Edit User Projects ({0})";
				public static LocalText SaveSuccess = "Updated user Projects.";
			}
        ...
        public static partial class Validation
        {
            ...
            public static LocalText EmailSubjectError = "Subject is Empty for {0) Record";
            public static LocalText EmailBodyError = "Body is Empty for {0) Record";
            public static LocalText EmailToEmailError = "ToEmpail is Empty for {0) Record";

            public static object InvalidEmailFormatError = "Invalid ToEmail for {0} Record";
        }
    }
}