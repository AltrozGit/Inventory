namespace Indotalent.Administration {
    ...
    export class UserDialog extends Serenity.EntityDialog<UserRow, any> {
        ...
        protected getToolbarButtons()
        {
            ...
            buttons.push({
                title: Q.text('Site.UserDialog.EditProjectsButton'),
                cssClass: 'edit-projects-button',
                icon: 'fa-users text-blue',

               
                onClick: () => {
                    new UserProjectsDialog({
                        userID: this.entity.UserId,
                        username: this.entity.Username
                    }).dialogOpen();
                }
        ...
        protected updateInterface() {
            ...
            this.toolbar.findButton('edit-projects-button').toggleClass('disabled', this.isNewOrDeleted());
        }
