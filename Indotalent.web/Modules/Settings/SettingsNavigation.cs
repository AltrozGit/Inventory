...
[assembly: NavigationLink(int.MaxValue, "Settings/State", typeof(MyPages.StateController), icon: "fa-folder")]
[assembly: NavigationLink(int.MaxValue, "Settings/Country", typeof(MyPages.CountryController), icon: "fa-folder")]