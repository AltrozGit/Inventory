...
{
    [LookupScript]
    public sealed class SalesTaxTDSLookup : RowLookupScript<SalesTaxRow>
    {
        private readonly ISqlConnections _sqlConnections;
        private readonly IUserRetrieveService _userRetrieveService;
        private readonly IUserAccessor _userAccessor;

        public SalesTaxTDSLookup(ISqlConnections sqlConnections, IUserRetrieveService userRetrieveService, IUserAccessor userAccessor)
            : base(sqlConnections)
        {
        ...
        protected override void PrepareQuery(SqlQuery query)
        {
            ...
            if (user != null)
            {
                ...
                query.Where(
                    SalesTaxRow.Fields.TaxType == (int)SalesTaxType.TDS &&
