...
{
    [LookupScript]
    public sealed class PurchaseTaxTDSLookup : RowLookupScript<PurchaseTaxRow>
    {
        private readonly ISqlConnections _sqlConnections;
        private readonly IUserRetrieveService _userRetrieveService;
        private readonly IUserAccessor _userAccessor;

        public PurchaseTaxTDSLookup(ISqlConnections sqlConnections, IUserRetrieveService userRetrieveService, IUserAccessor userAccessor)
            : base(sqlConnections)
        {
        ...
        protected override void PrepareQuery(SqlQuery query)
        {
            ...
            if (user != null)
            {
                ...
                query.Where(
                    PurchaseTaxRow.Fields.TaxType == (int)PurchaseTaxType.TDS &&
