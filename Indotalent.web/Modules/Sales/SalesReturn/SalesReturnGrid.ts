...
namespace Indotalent.Sales {
    ...
    export class SalesReturnGrid extends Serenity.EntityGrid<SalesReturnRow, any> {
        protected getColumnsKey() { return SalesReturnColumns.columnsKey; }
        ...
        protected getColumns() {
            ...
            columns.splice(2, 0, {
                ...
                width: 100,
                format: (ctx) => {
                    const returnItem = ctx.item as SalesReturnRow;
            ...
            if (!Q.Authorization.hasPermission("Administration:Tenant")) {
                columns = columns.filter(x => x.field != SalesReturnRow.Fields.TenantName && x.field != SalesReturnRow.Fields.Id);
            }
