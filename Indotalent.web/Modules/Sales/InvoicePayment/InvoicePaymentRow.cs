...
using System.IO;
using Indotalent.Web.Modules.Settings.CashBank;
using Indotalent.Web.Modules.Merchandise.Product;

namespace Indotalent.Sales
{
    [ConnectionKey("Default"), Module("Sales"), TableName("[dbo].[InvoicePayment]")]
    ...
    public sealed class InvoicePaymentRow : LoggingRow<InvoicePaymentRow.RowFields>, IIdRow, INameRow, IMultiTenantRow
    {
        ...
        [DisplayName("Invoice#"), NotNull, ForeignKey("[dbo].[Invoice]", "Id"), LeftJoin("jInvoice"), TextualField("InvoiceNumber")]
        ...
        [DisplayName("Invoice Payment"), Size(200), NotNull, QuickSearch, NameProperty]
        ...
        [DisplayName("Payment Date"), NotNull,QuickSearch]
        ...
        [DisplayName("Cash Bank"), NotNull, ForeignKey("[dbo].[CashBank]", "Id"), LeftJoin("jCashBank"), TextualField("CashBankName")]
        [LookupEditor(typeof(CashBankLookup), InplaceAdd = true, DialogType = "Indotalent.Settings.CashBankDialog")]
        ...
        [DisplayName("Sales Order"), Expression("jInvoice.[SalesOrderId]"), ForeignKey("[dbo].[SalesOrder]", "Id"), LeftJoin("jSalesOrder")]
        ...
        [DisplayName("Upload Supporting Documents")]
        [MultipleFileUploadEditor(FilenameFormat = "Document/InvoicePayment/~")]
        public string SupportingDocuments
        {
            get => fields.SupportingDocuments[this];
            set => fields.SupportingDocuments[this] = value;
        }
        [DisplayName("Payment Mode")]
        public String PaymentMode
        {
            get => fields.PaymentMode[this];
            set => fields.PaymentMode[this] = value;
        }
        [DisplayName("Transaction Number")]
        public String TransactionNumber
        {
            get => fields.TransactionNumber[this];
            set => fields.TransactionNumber[this] = value;
        }
        ...
        public class RowFields : LoggingRowFields
        {
            ...
            public StringField SupportingDocuments;
            public StringField PaymentMode;
            public StringField TransactionNumber;
