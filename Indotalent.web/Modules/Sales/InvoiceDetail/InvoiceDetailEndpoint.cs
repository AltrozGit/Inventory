...
namespace Indotalent.Sales.Endpoints
{
    ...
    public class InvoiceDetailController : ServiceEndpoint
    {
        ...
        public InvoiceDetailIsInvoicePaymentGeneratedResponse CheckInvoicePaymentGenerated(IDbConnection connection, InvoiceDetailIsInvoicePaymentGeneratedRequest request,
            [FromServices] IInvoiceDetailIsInvoicePaymentGeneratedHandler handler)
        {
            return handler.CheckInvoicePaymentGenerated(connection, request);
        }
    }
}