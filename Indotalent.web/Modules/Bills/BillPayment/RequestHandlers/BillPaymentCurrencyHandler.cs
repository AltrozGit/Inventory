...
namespace Indotalent.Bills
{
    ...
    {
        BillPaymentCurrencyResponse CheckBillPaymentCurrencyGenerated(IDbConnection connection, BillPaymentCurrencyRequest request);
    ...
    public class BillPaymentCurrencyHandler : IBillPaymentCurrencyHandler
    {
        ...
        public BillPaymentCurrencyResponse CheckBillPaymentCurrencyGenerated(IDbConnection connection, BillPaymentCurrencyRequest request)
        {
