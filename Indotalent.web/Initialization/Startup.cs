...
//using Indotalent.Web.Modules.Reminder.BulkEmailFileUpload.RequestHandlers;
...
namespace Indotalent
{
    public partial class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IEmailNotificationSaveHandler, EmailNotificationSaveHandler>();
            services.AddScoped<EmailNotificationService>();
            services.AddScoped<IBulkEmailFileUploadSaveHandler, BulkEmailFileUploadSaveHandler>();
            services.AddScoped<BulkEmailService>();
            services.AddScoped<SubscriptionService>();
            services.AddScoped<ISubscriptionAuditSaveHandler, SubscriptionAuditSaveHandler>();

            services.AddScoped<IPlanSaveHandler, PlanSaveHandler>();
            services.AddTransient<ITenantDetailsHandler, TenantDetailsHandler>();

            //services.AddScoped<IPurchaseOrderDetailGetQuantityOfPOCreatedHandler, PurchaseOrderDetailGetQuantityOfPOCreatedHandler>();

            //services.AddTransient<SendWhatsAppMessageService>();


            //var connectionString = Configuration.GetConnectionString("ConnectionString");
            //if (string.IsNullOrEmpty(connectionString))
            //{
            //    throw new InvalidOperationException("Database connection string is not configured. Please check your appsettings.json.");
            //}
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory, IAntiforgery antiforgery)
        {
            ...
            logger.LogInformation($"Logging to file: {path}\\Logs\\log-.txt");
