...

{
    ...
    [Migration(20250722115748)]

    public class DefaultDB_20250722_115748_AddGetInventoryDataSP : ForwardOnlyMigration
...
CREATE PROCEDURE [dbo].[GetInventoryData]
   @HRMSTenantID INT,
    @HrmsTenantName NVARCHAR(100),
    @PayrollCharges FLOAT,
    @PayrollId INT,
    @TotalGross FLOAT
AS
BEGIN
    ...
    -- Step 1: Declare table to receive data from GETHRMSDATA
    --DECLARE @HRMSData TABLE (
    --    HrmsTenantName NVARCHAR(100),
    --    PayrollCharges FLOAT,
    --    PayrollId INT,
    --    TotalGross FLOAT
    --    --PayrollChargesAmount FLOAT
    --);

    -- Step 2: Call GETHRMSDATA and populate data
    --INSERT INTO @HRMSData
    --EXEC GETHRMSDATA @HRMSTenantID, @PayrollId;
    ...
    DECLARE
      ...
      --  @PayrollCharges FLOAT,
        ...
        @PayrollPercent FLOAT,
        @CustomerName NVARCHAR(100),
        @NormalizedCustomerName NVARCHAR(255),
        @CustomerId INT;

  SET @CustomerName = @HrmsTenantName;
    SET @PayrollPercent = @PayrollCharges / 100;
    SET @PayrollChargesAmount = @TotalGross * @PayrollPercent;

    -- Set default Inventory tenant
    ...
    -- Step 5: Check or Insert Inventory Tenant
    ...
    -- Step 6: Normalize Customer name and check or insert
