namespace Indotalent.Purchase {
    export namespace PurchaseOrderDetailService {
        ...
        export declare function CheckBillGenerated(request: PurchaseOrderDetailIsBillGeneratedRequest, onSuccess?: (response: PurchaseOrderDetailIsBillGeneratedResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        export declare function GetQuantityOfPOCreated(request: Web.Modules.Material.Issue.RequestHandlers.PurchaseOrderDetailGetQuantityOfPOCreatedRequest, onSuccess?: (response: Web.Modules.Material.Issue.RequestHandlers.PurchaseOrderDetailGetQuantityOfPOCreatedResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        ...
        export declare const enum Methods {
            ...
            CheckBillGenerated = "Purchase/PurchaseOrderDetail/CheckBillGenerated",
            GetQuantityOfPOCreated = "Purchase/PurchaseOrderDetail/GetQuantityOfPOCreated"
        }
