namespace Indotalent.Purchase {
    export namespace PurchaseOrderService {
        ...
        export declare function GetTenant(request: PurchaseOrderTenantRequest, onSuccess?: (response: PurchaseOrderTenantResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        ...
        export declare const enum Methods {
            ...
            GetTenant = "Purchase/PurchaseOrder/GetTenant"
        }
