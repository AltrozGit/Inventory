namespace Indotalent.Inventory {
    export namespace ShipperService {
        export const baseUrl = 'Inventory/Shipper';
        ...
        export declare const enum Methods {
            Create = "Inventory/Shipper/Create",
            Update = "Inventory/Shipper/Update",
            Delete = "Inventory/Shipper/Delete",
            Retrieve = "Inventory/Shipper/Retrieve",
            List = "Inventory/Shipper/List"
        }
